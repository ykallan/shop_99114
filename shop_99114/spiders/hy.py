...
class HySpider(scrapy.Spider):
    ...
    def parse_detail(self, response):
        ...
        com_name = response.xpath('//p[@class="companyname"]/span/a/text()').get()
        cont_name = response.xpath('//div[@class="sj-line sjDiv2"]/p[1]/span[2]/i/text()').get()
        jingyingmoshi = response.xpath('//div[@class="sj-line sjDiv2"]/p[2]/span[2]/text()').get()
        zhuyingyewu = response.xpath('//div[@class="sj-line sjDiv2"]/p[3]/span[2]/text()').get()
        loc = response.xpath('//div[@class="sj-line sjDiv2"]/p[4]/span[2]/text()').get()
        mobile = response.xpath('//li[@class="picContact clearfix"]/div/p[2]/span[2]/text()').get()
        ...
        # print(com_name, cont_name, jingyingmoshi, zhuyingyewu, loc, mobile)
        # print(dianhua, chuanzhen, youxiang, address)
        item = Shop99114Item()
